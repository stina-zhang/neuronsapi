...
class SendEmail:
    ...
    send_user = "yuhe587853@163.com"
    password = "MBBHPIKRSQOOEBXS"

    def send_mail(self,user_list,sub,content):
        user = "Neurons"+"<"+send_user+">"
        ...
        # 添加邮件附件
        file_part = MIMEApplication(open('/Users/stina/PycharmProjects/neuronsapi/test_case/neuronsapitest.xls', 'rb').read())
        file_part.add_header('Content-Disposition', 'attachment', filename="neuronsapitest.xls")
