...
class run_room_del(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        '''读测试用例sheet'''
        cls.data = GetData(fileName='/Users/stina/Desktop/apitest.xls', sheetName='room_del')
        cls.run_method = RunMethod()
        cls.com_util = CommonUtil()

    def test_run_room_del(self):
        res = None
        ...
        for i in range(1, rows_count):
            ...
            request_data = re.sub('rid', self.roomid, request_data_old)
            ...
            if self.com_util.is_equal_str(expect, res) == 1:
                ...
                logging.info("**********room_del test success***********")
                globalvar.pass_count.append(i)
            else:
                self.data.write_result(i, 'fail')
                logging.info("**********room_del test fail***********")
