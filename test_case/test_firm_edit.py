...
class run_firm_edit(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        '''读测试用例sheet'''
        cls.data = GetData(fileName='/Users/stina/Desktop/apitest.xls', sheetName='firm_edit')
    ...
    def test_run_firm_edit(self):
        ...
        for i in range(1, rows_count):
            ...
            if self.com_util.is_equal_str(expect, res) == 1:
                ...
                logging.info("**********firm_edit test success***********")
                globalvar.pass_count.append(i)
            else:
                self.data.write_result(i, 'fail')
                logging.info("**********firm_edit test fail***********")
